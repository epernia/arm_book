...
#define DISPLAY_HIGH_WAIT_US       200   // 100 us

#define DISPLAY_CMD_WAIT_US        220   // 110 us Wait time for every command 45 us, except:
#define DISPLAY_CLR_DISP_WAIT_MS   5     // - 3 ms Clear Display 1.52 ms
#define DISPLAY_RET_HOME_WAIT_MS   5     // - 3 ms Return Home  1.52 ms
