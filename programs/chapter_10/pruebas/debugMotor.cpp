//archivo pc_serial_com.cpp con debug para motor
...
{
    if ( gs1Read() ) {
        uartUsb.printf( "gs1 is HIGH\r\n");
    } else {
        uartUsb.printf( "gs1 is LOW\r\n");
    }
    if ( gs2Read() ) {
        uartUsb.printf( "gs2 is HIGH\r\n");
    } else {
        uartUsb.printf( "gs2 is LOW\r\n");
    }
    if ( ls1Read() ) {
        uartUsb.printf( "ls1 is HIGH\r\n");
    } else {
        uartUsb.printf( "ls1 is LOW\r\n");
    }
    if ( ls2Read() ) {
        uartUsb.printf( "ls2 is HIGH\r\n");
    } else {
        uartUsb.printf( "ls2 is LOW\r\n");
    }
    if ( motorDirection1StateRead() ) {
        uartUsb.printf( "motorDirection1State is HIGH\r\n");
    } else {
        uartUsb.printf( "motorDirection1State is LOW\r\n");
    }
    if ( motorDirection2StateRead() ) {
        uartUsb.printf( "motorDirection2State is HIGH\r\n");
    } else {
        uartUsb.printf( "motorDirection2State is LOW\r\n");
    }
    if ( limitSwitch1StateRead() ) {
        uartUsb.printf( "limitSwitch1State is HIGH\r\n");
    } else {
        uartUsb.printf( "limitSwitch1State is LOW\r\n");
    }
    if ( limitSwitch2StateRead() ) {
        uartUsb.printf( "limitSwitch2State is HIGH\r\n");
    } else {
        uartUsb.printf( "limitSwitch2State is LOW\r\n");
    }
}
