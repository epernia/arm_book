...
{
    if ( !motorM1PinRead() ) {
        uartUsb.printf( "The motor is moving in direction 1\r\n");
    } else if ( !motorM2PinRead() ) {
        uartUsb.printf( "The motor is moving in direction 2\r\n");
    } else {
        uartUsb.printf( "The motor is stopped\r\n");
    }
